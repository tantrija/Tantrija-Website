            ...
            <div className="col-lg-3 mb-3 ps-lg-5">
                <div className="ps-lg-5">
                    ...
                    <ul className="list-unstyled">
                        <li className="mb-3"><a href="#" className="footer-link text-uppercase">Home</a></li>
                        <li className="mb-3"><a href="#" className="footer-link text-uppercase">About</a></li>
                        <li className="mb-3"><a href="#" className="footer-link text-uppercase">Services</a></li>
                        <li className="mb-3"><a href="#" className="footer-link text-uppercase">Industries</a></li>
                        <li className="mb-3"><a href="#" className="footer-link text-uppercase">Insights</a></li>
                    </ul>
                </div>
            </div>
            <div className="col-lg-3 mb-3 ps-lg-5">
                ...
                <ul className="list-unstyled">
                    <li className="mb-3"><a href="#" className="footer-link text-uppercase">Support</a></li>
                    <li className="mb-3"><a href="#" className="footer-link text-uppercase">Contact</a></li>
                    <li className="mb-3"><a href="#" className="footer-link text-uppercase">Privacy</a></li>
                    <li className="mb-3"><a href="#" className="footer-link text-uppercase">Terms of Use</a></li>
                </ul>
            </div>
            <div className="col-lg-3 mb-3">
                <h6 className="text-warning text-uppercase mb-3">Contact Info</h6>
                <p className="text-muted mb-2 mt-0">Email: <a href="mailto:info@blochain.com">info@blochain.com</a></p>
                <p className="text-muted">46, Leighton Road, London, England W13 9EH</p>
            </div>
            <div className="col-lg-12 my-4">
            <hr />
            <p className="text-muted text-center mt-4">Copyright © 2023 Blochain. All Rights Reserved.</p>
            </div>
            </div>
        </div>
      </div>
