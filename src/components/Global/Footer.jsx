                ...
                <div className="row mt-3">
                    <div className="col-lg-3 mb-3">
                        ...
                        <div className="d-flex align-items-center gap-3 mb-4">
                            ...
                            <a href="https://www.linkedin.com/in/tantrija-enterprises-274921314/" target="_blank" className="footer-social">
                            ...
                            <a href="https://x.com/Tantrijadotcom" target="_blank" className="footer-social">
                    ...
                    <div className="col-lg-3 mb-3">
                        ...
                        <p className="text-muted mb-2 mt-0">Whatsapp Number: <a target="_blank" href="https://wa.me/7420969224">+91 7420969224</a></p>
                        <p className="text-muted">E-1804, R9 - Life Republic, Pune,<br />Maharastra, India</p>
                    </div>
                    <div className="col-lg-12 my-4">
                        <hr />
                        <p className="text-muted text-center mt-4">Copyright © 2024 Tantrija. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
